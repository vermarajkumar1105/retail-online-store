package com.retail.online.store.app.test;
...
import com.retail.online.store.app.RetailOnlineStoreApplication;
import com.retail.online.store.builder.BillBuilder;
import com.retail.online.store.builder.RetailOnlineStoreBill;
import com.retail.online.store.builder.UserBuilder;
...
@SpringBootTest
@ComponentScan({ "com.retail.online.store.*" })
@EnableAutoConfiguration
public class RetailOnlineStoreApplicationTests {
	...
	@InjectMocks
	RetailOnlineStoreBill retailSite;
	...
	@Test
	public void main() {
		RetailOnlineStoreApplication.main(new String[] {});
	}
